...
module.exports = Soup = (function() {
  ...
  Soup.prototype.setAttribute = function(selector, name, _value) {
    var attr, attrDetails, attrGotUpdated, attrString, attributes, element, endInsideOpeningTag, endOfAttributeIndex, newAttrString, openingTagString, quoteType, type, valEnd, valStart, value, _i, _j, _len, _len1, _ref;
    this._build();
